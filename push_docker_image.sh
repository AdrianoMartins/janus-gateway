...
then
    ...
    docker tag softphone_janus_debug docker.aytytech.com/softphone_webrtc_janus:v1.0_debug
    ...
    docker push docker.aytytech.com/softphone_webrtc_janus:v1.0_debug
else
